...
import {User as UserType} from '@/store/type';
        ...
        >
          ...
          <template #append>
            <div @click="passwordTypeChange" class="eye">
              <svg v-if="passwordType === PasswordType.Password" class="password-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5156" width="48" height="48">
                <path d="M467.911111 775.68h-2.56 2.56z m-4.835555-1.991111z m-1.991112 0z m6.826667 2.844444a62.008889 62.008889 0 0 0 21.333333 3.413334 60.871111 60.871111 0 0 1-21.333333-3.413334z m23.608889 3.128889z m2.275556 0z m43.804444-30.151111z m0 0" fill="#FFFFFF" p-id="5157"></path>
                <path
                    ...
                    fill="#C6CACD" p-id="5158"></path>
              </svg>
              <svg v-else class="password-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5364" width="48" height="48">
                <path
